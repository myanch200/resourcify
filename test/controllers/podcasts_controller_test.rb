...
class PodcastsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create podcast" do
    assert_difference("Podcast.count") do
      post podcasts_url, params: { podcast: { descrption: @podcast.descrption, name: @podcast.name } }
    end
  ...
  test "should update podcast" do
    patch podcast_url(@podcast), params: { podcast: { descrption: @podcast.descrption, name: @podcast.name } }
